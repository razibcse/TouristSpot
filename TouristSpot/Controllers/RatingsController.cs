...
namespace TouristSpot.Controllers
{
    public class RatingsController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("Id,TotalRating,AverageRating,PostId")] Rating rating)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        _context.Add(rating);
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,TotalRating,AverageRating,PostId")] Rating rating)
        //{
        //    if (id != rating.Id)
        //    {
        //        return NotFound();
